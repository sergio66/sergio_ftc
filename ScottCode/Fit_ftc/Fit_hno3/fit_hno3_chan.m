%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Do a fit of offset HNO3 for a single channel
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

load refprof_hno3.mat

datafile='alldata_hno3_long.mat';
...
for il = 1:100
   ...
   if (il == 1)
      lk = squeeze( zodhno3(ichan,il,:) );
   else
      lk = squeeze( zodhno3(ichan,il,:) ) - squeeze( zodhno3(ichan,ilm1,:) );
   end
...
%      plot(lang,calc./weight','ro',lang,rcalc./weight','go')
      plot(lang,bcalc./weight','cx')
      hold
      title([ 'k: layer' eval([' int2str(il) ']) ]);
      subplot(3,1,2),plot(lang,lkz,'b+'),grid
      %
      subplot(3,1,3)
%      plot(lang,100*(wk-calc)./wk,'ro',lang,100*(wk-bcalc)./wk,'c*'),grid
