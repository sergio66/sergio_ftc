c This version for fwo "sw" (small water) 3 term water fit
C=======================================================================
C=======================================================================
C
...
C    This version is for FWO and FOW.  Although it works with FOW, it
...
C    --------- ----------------- ---------------------------------------
C    24 Jun 97 Scott Hannon      Created from 11 term FWO fit
...
C      Check the gases are as expected
 ...
 1010     FORMAT('Error: fitw_fwo_sw3 expected NUMGAS=3, not ',I2)
          STOP
       ENDIF
       IF ((IGASF .NE. 1) .OR.
 ...
 1020     FORMAT('Error: fitw_fwo_sw3 expected LSTGAS=(',I2,
     $    ',[1 or 3], [3 or 1]), not (',I2,',',I2,',',I2,')')
          STOP
       ENDIF
       IF (NPREDW .NE. 3) THEN
          WRITE(IOERR,1030) NPREDW
 1030     FORMAT('Error: fitw_fwo_sw3 expecting NPREDW=3, not ',I2)
          STOP
       ENDIF
C
C
