...
!CALL PROTOCOL:
C    FITP(LSTGAS, ICHAN, NDTPTS, NNEG, IOFFST, PRED, KLTOS, KLAYER,
...
C    --------- ----------------- ---------------------------------------
C    21 Sep 99 Scott Hannon      Created based on fitf_f8
...
C      =================================================================
       SUBROUTINE FITP(LSTGAS, ICHAN, NDTPTS, NNEG, IOFFST, PRED,
...
C
 ...
 1030     FORMAT('Error: fitp expecting NPREDP=4, not ',I2)
          STOP
       ENDIF
C
C
