...
C    coefficients.
C    This version for fitting gases: Fixed, Methane, and Water
...
C    --------- ----------------- ---------------------------------------
C    30 Aug 99 Scott Hannon      Created from fitftc_fwo
...
C
      write(6,*) 'methane'
          CALL FITM(LSTGAS,ICHAN,NUANG,NDTPTS,NNEG,IOFFST,PRED,KLTOS,
     $       KLAYER, KZMIN, KZMAX, KMIN, KMAX, SECANG, FTCOEF)
C
      write(6,*) 'water'
