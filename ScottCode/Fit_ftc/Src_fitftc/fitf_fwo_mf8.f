c This version is for fwo and fow "mf" 8 term fit
C=======================================================================
C=======================================================================
C
...
C    --------- ----------------- ---------------------------------------
C    30 Jun 97 Scott Hannon      Created from fitf_fwo_sun11
...
C      Check the gases are as expected
 ...
 1010     FORMAT('Error: fitf_fwo_mf8 expected NUMGAS=3, not ',I2)
          STOP
       ENDIF
       IF ((IGASF .NE. 1) .OR.
 ...
 1020     FORMAT('Error: fitf_fwo_mf8 expected LSTGAS=(',I2,
     $    ',[1 or 3], [3 or 1]), not (',I2,',',I2,',',I2,')')
          STOP
       ENDIF
       IF (NPREDF .NE. 8) THEN
          WRITE(IOERR,1030) NPREDF
 1030     FORMAT('Error: fitf_fwo_mf8 expecting NPREDF=8, not ',I2)
          STOP
       ENDIF
C
C
