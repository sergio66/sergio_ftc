...
!CALL PROTOCOL:
C    FITM(LSTGAS, ICHAN,NUANG,NDTPTS, NNEG, IOFFST, PRED, KLTOS, KLAYER,
...
C      =================================================================
       SUBROUTINE FITM(LSTGAS, ICHAN,NUANG,NDTPTS, NNEG, IOFFST, PRED,
...
C
     ...
     $             (XKM .GT. 4.0E-4) .AND. (IUANG .GE. 2)) THEN
                      MXPRED=4
                      LUSE(4)=.TRUE.
                      MXUSE=4
C
...
C
                            IF ((MPTS .GT. MINPTS(MXUSE+1)) .AND.
     $                      (XKZ .LT. 6.0E+0) .AND. (IUANG .GE. 3)) THEN
                               MXPRED=7
                               LUSE(7)=.TRUE.
                               MXUSE=MXUSE + 1
C
