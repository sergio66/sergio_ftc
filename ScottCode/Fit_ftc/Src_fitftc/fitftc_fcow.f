...
C    coefficients.
C    This version for fitting gases: Fixed, Carbonmonoxide, Water,
C    and Ozone
...
C    27 Aug 99 Scott Hannon      Add LSTGAS; made more generic
...
C
      write(6,*) 'ichan=',ichan
C
          CALL RDCHAN(ICHAN, IOIN, ISORTK, NUANG, NDTPTS, NNEG, IDCHAN,
     $       FREQ, KLTOS, KLAYER, KZMIN, KZMAX, KMIN, KMAX)
C
      write(6,*) 'fixed'
          CALL FITF(LSTGAS,ICHAN,NUANG,NDTPTS,NNEG,IOFFST,PRED,KLTOS,
     $       KLAYER, KZMIN, KZMAX, KMIN, KMAX, SECANG, FTCOEF)
C
      write(6,*) 'carbon monoxide'
          CALL FITC(LSTGAS,ICHAN,NUANG,NDTPTS,NNEG,IOFFST,PRED,KLTOS,
     $       KLAYER, KZMIN, KZMAX, KMIN, KMAX, SECANG, FTCOEF)
C
      write(6,*) 'ozone'
...
C
      write(6,*) 'water'
          CALL FITW(LSTGAS,ICHAN,NUANG,NDTPTS,NNEG,IOFFST,PRED,KLTOS,
     $       KLAYER, KZMIN, KZMAX, KMIN, KMAX, SECANG, FTCOEF)
C
