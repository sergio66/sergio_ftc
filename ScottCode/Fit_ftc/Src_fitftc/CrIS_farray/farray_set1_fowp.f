C***********************************************************************
C This version for set1 using FOWP ddata files
C FOW fit with (8 fixed, 11 water, 5 ozone)
C
...
C
ccc
c       PARAMETER(DKMIN=1.7D-5)
c       PARAMETER(DKMAX=6.3D+0)
cC
c       PARAMETER(DKZMIN=1.9D-5)
c       PARAMETER(DKZMAX=6.8D+0)
c       PARAMETER(TAUMIN=1.5E-5)
c       PARAMETER(TAUDEL=2.4E-5)
ccc
       PARAMETER(TAUMIN=0.8E-5)
       PARAMETER(TAUDEL=1.8E-5)
       PARAMETER(DKZMIN=1.3D-5)
       PARAMETER(DKZMAX=7.7D+0)
       PARAMETER(DKMIN=0.9D-5)
       PARAMETER(DKMAX=6.7D+0)
C
...
C      Note: Set FOWp also exists but is ignored
