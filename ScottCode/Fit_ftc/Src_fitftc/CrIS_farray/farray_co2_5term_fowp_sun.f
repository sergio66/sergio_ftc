...
C
cC      AIRS values
c       PARAMETER(DKMIN=1.0D-6)
c       PARAMETER(DKMAX=2.5D+1)
c       PARAMETER(DKZMIN=5.0D-7)
c       PARAMETER(DKZMAX=3.5E+1)
c       PARAMETER(TAUMIN=1.0E-15)
c       PARAMETER(TAUDEL=1.0E-11)
C
