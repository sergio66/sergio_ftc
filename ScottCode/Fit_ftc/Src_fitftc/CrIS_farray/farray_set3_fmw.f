...
C
ccc
c       PARAMETER(TAUMIN=1.0E-5)
c       PARAMETER(TAUDEL=2.0E-5)
c       PARAMETER(DKZMIN=1.5D-5)
c       PARAMETER(DKZMAX=6.8D+0)
c       PARAMETER(DKMIN=1.0D-5)
c       PARAMETER(DKMAX=6.2D+0)
c
ccc
       PARAMETER(TAUMIN=1.5E-6)
       PARAMETER(TAUDEL=2.5E-6)
       PARAMETER(DKZMIN=2.0D-6)
       PARAMETER(DKZMAX=7.7D+0)
       PARAMETER(DKMIN=1.5D-6)
       PARAMETER(DKMAX=7.1D+0)
ccc
C
C       IASI
c       PARAMETER(TAUMIN=5.5E-5)
c       PARAMETER(TAUDEL=5.5E-5)
c       PARAMETER(DKZMIN=7.0D-5)
c       PARAMETER(DKZMAX=6.2D+0)
c       PARAMETER(DKMIN=5.5D-5)
c       PARAMETER(DKMAX=6.0D+0)
ccc
C
