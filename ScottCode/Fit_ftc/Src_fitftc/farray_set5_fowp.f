...
ccc
C       mostly safe CrIS
c       PARAMETER(TAUMIN=0.8E-5)
c       PARAMETER(TAUDEL=1.8E-5)
c       PARAMETER(DKZMIN=1.3D-5)
c       PARAMETER(DKZMAX=7.7D+0)
c       PARAMETER(DKMIN=0.9D-5)
c       PARAMETER(DKMAX=6.7D+0)
ccc
C      unsafe CrIS but still useful
