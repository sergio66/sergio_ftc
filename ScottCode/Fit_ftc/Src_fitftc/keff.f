...
C       KZMIN, KZMAX, KMIN, KMAX, LANGLE)
...
C    LOG ARR    LANGLE         angle flag         none
...
C     6 May 03 Scott Hannon      Modified for use with the standard
C                                   AIRS production code
C    19 Dec 07 Scott Hannon      Add LANGLE angle flag
...
C      =================================================================
     ...
     $    NNEG, KZMIN, KZMAX, KMIN, KMAX, LANGLE)
C      =================================================================
...
C
             DO IGAS=1,NUMGAS
                IF (TAULTS(IANG,ILAY,ISORTK(IGAS)) .GT. TAUMIN) THEN
                   DKZRAW(IGAS)=-DLOG(
...
C                  two combined gas transmittances.
                   XDT=TAULTS(IANG,ILAY,ISORTK(IGAS-1)) -
     $                 TAULTS(IANG,ILAY,ISORTK(IGAS))
