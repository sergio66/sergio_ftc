%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Do a fit of offset SO2 for all channels in input file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

load refprof

datafile=input('Enter name of cris SO2 data file : ','s');
...
%eval(['save cris_allcoef_so2_' band ' ichan fchan maxso2 allcoef so2_mult'])
eval(['save ' name '_allcoef_so2_' band ' ichan fchan maxso2 allcoef so2_mult'])
