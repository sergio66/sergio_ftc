% Program MODISfitthermband
%
% Reads in reflected thermal regression data and fits for the
% F-factor coefficients.
%

% Update: 16 April 2002, Scott Hannon - minor changes for the
%    April 2002 production code package
% Update: 16 September 2002, Scott Hannon - multiply ttorad by 0.001
%    (1/1000) to convert mW to W
% Update: 15 Aug 2005, S.Hannon - minor update for MODIS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
inname='../Data/modisthermdata_';


% Output F-factor coefficient file name
outname='modis_therm_fcoef_';
...
eval(['save ' outname band ' coefall rmsall layabove freq idchan band'])
