...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       ...
       PARAMETER( VSCOEF = 'AIRS 08-04-25 Apr08 m150' )
...
C
       PARAMETER(FNCOF1=
     $ '../../CutCoef/set1_m150.dat')
       PARAMETER(FNCOF2=
     $ '../../CutCoef/set2_m150.dat')
       PARAMETER(FNCOF3=
     $ '../../CutCoef/set3_m150.dat')
       PARAMETER(FNCOF4=
     $ '../../CutCoef/set4_m150.dat')
       PARAMETER(FNCOF5=
     $ '../../CutCoef/set5_m150.dat')
       PARAMETER(FNCOF6=
     $ '../../CutCoef/set6_m150.dat')
       PARAMETER(FNCOF7=
     $ '../../CutCoef/set7_m150.dat')
       PARAMETER(FNCO2 =
     $ '../../CutCoef/co2_m150.dat')
       PARAMETER(FNSO2 =
     $ '../../CutCoef/so2_m150.dat')
       PARAMETER(FNHNO3 =
     $ '../../CutCoef/hno3_m150.dat')
       PARAMETER(FNN2O =
     $ '../../CutCoef/n2o_m150.dat')
       PARAMETER(FNOPTR=
     $ '../../CutCoef/optran_m150.dat')
       PARAMETER(FNTHER=
     $ '../../CutCoef/therm_m150.dat')
       PARAMETER(FNFX  =
     $ '../../CutCoef/fx.txt')
       PARAMETER(FNPREF=
     $ '../../CutCoef/profref_trace385')
       PARAMETER(FNSUN =
     $ '../../Solar/solar_m150.txt')
       PARAMETER(FNCOFN=
     $ '../../CutCoef/setnte_m150.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '../../Tunmlt/tunmlt_m150_wcononly.txt')
