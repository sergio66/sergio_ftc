...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       ...
       PARAMETER( VSCOEF = 'x    08-04-25 AIRS Apr08 XCSNAMEX' )
...
c       PARAMETER(MXCHAN = 2834)
       PARAMETER(MXCHAN = 2835) ! one extra channel for dummy coefs
       PARAMETER(NFCOEF = 6)
...
C
       PARAMETER(FNCOF1=
c     $ '../../Coef/merged_set1_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set1.dat')
     $ '../../CutCoef/set1_XCSNAMEX.dat')
       PARAMETER(FNCOF2=
c     $ '../../Coef/merged_set2_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set2.dat')
     $ '../../CutCoef/set2_XCSNAMEX.dat')
       PARAMETER(FNCOF3=
c     $ '../../Coef/merged_set3_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set3.dat')
     $ '../../CutCoef/set3_XCSNAMEX.dat')
       PARAMETER(FNCOF4=
c     $ '../../Coef/merged_set4_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set4.dat')
     $ '../../CutCoef/set4_XCSNAMEX.dat')
       PARAMETER(FNCOF5=
c     $ '../../Coef/merged_set5_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set5.dat')
     $ '../../CutCoef/set5_XCSNAMEX.dat')
       PARAMETER(FNCOF6=
c     $ '../../Coef/merged_set6_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set6.dat')
     $ '../../CutCoef/set6_XCSNAMEX.dat')
       PARAMETER(FNCOF7=
c     $ '../../Coef/merged_set7_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_set7.dat')
     $ '../../CutCoef/set7_XCSNAMEX.dat')
       PARAMETER(FNCO2 =
c     $ '../../Coef/XCSNAMEX_rawcoef_co2_fowp.dat')
c     $ '../../CutCoef/co2_XCSNAMEX.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNSO2 =
c     $ '../../CutCoef/so2_XCSNAMEX.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNHNO3 =
c     $ '../../CutCoef/hno3_XCSNAMEX.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNN2O =
c     $ '../../CutCoef/n2o_XCSNAMEX.dat')
     $ '../../CutCoef/dummy_n2o.dat')
       PARAMETER(FNOPTR=
c     $ '../../Coef/merged_optran_fowp_XCSNAMEX.dat')
c     $ '../../Coef/merged_optran_fmw_XCSNAMEX.dat')
c     $ '../../CutCoef/dummy_optran.dat')
     $ '../../CutCoef/optran_XCSNAMEX.dat')
       PARAMETER(FNTHER=
     $ 'no_such_file')
       PARAMETER(FNFX  =
     ...
     $ '../../Scripts/profref_trace385')
       PARAMETER(FNSUN =
     $ '/spinach/s6/hannon/AIRS_prod08/Fit_ftc/Solar/solar_XCSNAMEX.txt')
       PARAMETER(FNCOFN=
c     $ '/asl/data/sarta_database/Data_jan04untun/Coef/setnte_oct05.dat')
     $ '../../CutCoef/setnte_XCSNAMEX.dat')
C
C
...
C
       PARAMETER(FNTMLT=
c     $ '../../Tunmlt/tunmlt_XCSNAMEX_wcononly.txt')
     $ '../../Tunmlt/tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
