...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       PARAMETER( VSARTA = '1.07 07-05-02 trace CO2,SO2,HNO3,N2O' )
       PARAMETER( VSCOEF = '05-11-21 SRF=051118v4 tun=dec05deliv' )
...
C
       PARAMETER(FNCOF1=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set1nov05.dat')
       PARAMETER(FNCOF2=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set2nov05.dat')
       PARAMETER(FNCOF3=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/set7.dat')
       PARAMETER(FNCO2 =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/co2nov05.dat')
       PARAMETER(FNSO2 =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/n2o.dat')
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/optran.dat')
       PARAMETER(FNTHER=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/therm6.dat')
C
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/profref_trace')
       PARAMETER(FNSUN =
     $ '/asl/data/sarta_database/Data_jan04untun/Solar/solar_data.txt')
C
       PARAMETER(FNCOFN=
...
C
       PARAMETER(FNTMLT=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/'
     $ // 'tunmlt_dec05deliv.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
