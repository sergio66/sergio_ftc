...
C
     ...
     $ '../../CutCoef/set7_XCSNAMEX.dat')
       PARAMETER(FNCO2 =
     $ '../../CutCoef/co2_XCSNAMEX.dat')
       PARAMETER(FNSO2 =
     $ '../../CutCoef/so2_XCSNAMEX.dat')
       PARAMETER(FNHNO3 =
     $ '../../CutCoef/hno3_XCSNAMEX.dat')
       PARAMETER(FNN2O =
     $ '../../CutCoef/n2o_XCSNAMEX.dat')
       PARAMETER(FNOPTR=
     $ '../../CutCoef/optran_XCSNAMEX.dat')
       PARAMETER(FNTHER=
     $ '../../CutCoef/therm_XCSNAMEX.dat')
       PARAMETER(FNFX  =
     $ '../../CutCoef/fx.txt')
       PARAMETER(FNPREF=
     $ '../../CutCoef/profref_trace385')
       PARAMETER(FNSUN =
     $ '../../Solar/solar_XCSNAMEX.txt')
       PARAMETER(FNCOFN=
...
C
       PARAMETER(FNTMLT=
     $ '../../Tunmlt/tunmlt_XCSNAMEX_wcononly.txt')
c     $ '../../Tunmlt/tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
