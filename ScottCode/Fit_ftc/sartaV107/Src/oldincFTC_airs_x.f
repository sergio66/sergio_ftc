...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       ...
       PARAMETER( VSCOEF = 'x    08-04-15 AIRS Apr08 m130x' )
...
c       PARAMETER(MXCHN7 = 1)   ! dummy
       PARAMETER(MXCHN7 = 652) ! fow_short
       PARAMETER( N7CON = 7)
       PARAMETER( N7FIX = 8)
       PARAMETER( N7H2O = 13)
       PARAMETER(  N7O3 = 1)
...
c     $ '../../Coef/merged_set1_m130x.dat')
     $ '../../CutCoef/dummy_set1.dat')
       PARAMETER(FNCOF2=
c     $ '../../Coef/merged_set2_m130x.dat')
     $ '../../CutCoef/dummy_set2.dat')
       PARAMETER(FNCOF3=
c     $ '../../Coef/merged_set3_m130x.dat')
     $ '../../CutCoef/dummy_set3.dat')
       PARAMETER(FNCOF4=
c     $ '../../Coef/merged_set4_m130x.dat')
     $ '../../CutCoef/dummy_set4.dat')
       PARAMETER(FNCOF5=
c     $ '../../Coef/merged_set5_m130x.dat')
     $ '../../CutCoef/dummy_set5.dat')
       PARAMETER(FNCOF6=
c     $ '../../Coef/merged_set6_m130x.dat')
     $ '../../CutCoef/dummy_set6.dat')
       PARAMETER(FNCOF7=
     $ '../../Coef/merged_set7_m130x.dat')
...
c     $ '../../Coef/merged_optran_fmw_m130x.dat')
     ...
     $ '../../Scripts/profref_trace385')
       PARAMETER(FNSUN =
     $ '/spinach/s6/hannon/AIRS_prod08/Fit_ftc/Solar/solar_m130x.txt')
       PARAMETER(FNCOFN=
...
C
       PARAMETER(FNTMLT=
     $ '/spinach/s6/hannon/AIRS_prod08/Fit_ftc/Solar/tunmlt_ones.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
