...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       PARAMETER( VSARTA = '1.07 08-01-31' )
c       PARAMETER( VSCOEF = 'x    08-04-21 AIRS Apr08 m130x' )
       PARAMETER( VSCOEF = 'x    08-04-21 AIRS Apr08 m140x' )
...
c       PARAMETER(MXCHN1 = 1)    ! dummy
c       PARAMETER(MXCHN1 = 2182) ! fow_long
...
c       PARAMETER(MXCHN2 = 1)    ! dummy
c       PARAMETER(MXCHN2 = 2182) ! fow_long
...
c       PARAMETER(MXCHN3 = 1)  ! dummy
c       PARAMETER(MXCHN3 = 709) ! fmw
...
c       PARAMETER(MXCHN4 = 1)   ! dummy
c       PARAMETER(MXCHN4 = 168) ! fcow
       PARAMETER(MXCHN4 = 85)
       PARAMETER( N4CON = 7)
       PARAMETER( N4FIX = 11)
       PARAMETER(  N4CO = 11)
...
c       PARAMETER(MXCHN5 = 1)   ! dummy
c       PARAMETER(MXCHN5 = 652) ! fow_short
...
c       PARAMETER(MXCHN6 = 1)   ! dummy
c       PARAMETER(MXCHN6 = 652) ! fow_short
...
c       PARAMETER(MXCHN7 = 1)   ! dummy
c       PARAMETER(MXCHN7 = 652) ! fow_short
...
c       PARAMETER(MXCHNC = 2182) ! fow_long
c       PARAMETER(MXCHNC = 652)  ! fow_short
c       PARAMETER(MXCHNC = 1082)
       PARAMETER(  NCO2 = 4)
C
C
C      ----------------
...
c       PARAMETER(MXCHNW = 1)    ! dummy
c       PARAMETER(MXCHNW = 2182) ! fow_long
c       PARAMETER(MXCHNW = 709)  ! fmw
...
C      For non-LTE
C      -----------
       INTEGER MXCNTE ! max # of channels for non-LTE (201)
       INTEGER NNCOEF ! # of coefs for non-LTE
       PARAMETER(MXCNTE = 1)   ! dummy
       PARAMETER(NNCOEF = 6)
C
C      ---------
C      Filenames
...
C
       PARAMETER(FNCOF1=
c     $ '../../Coef/merged_set1_m130x.dat')
c     $ '../../CutCoef/dummy_set1.dat')
c     $ '../../CutCoef/set1_m130x.dat')
     $ '../../CutCoef/set1_m140x.dat')
       PARAMETER(FNCOF2=
c     $ '../../Coef/merged_set2_m130x.dat')
c     $ '../../CutCoef/dummy_set2.dat')
c     $ '../../CutCoef/set2_m130x.dat')
     $ '../../CutCoef/set2_m140x.dat')
       PARAMETER(FNCOF3=
c     $ '../../Coef/merged_set3_m130x.dat')
c     $ '../../CutCoef/dummy_set3.dat')
c     $ '../../CutCoef/set3_m130x.dat')
     $ '../../CutCoef/set3_m140x.dat')
       PARAMETER(FNCOF4=
c     $ '../../Coef/merged_set4_m130x.dat')
c     $ '../../CutCoef/dummy_set4.dat')
c     $ '../../CutCoef/set4_m130x.dat')
     $ '../../CutCoef/set4_m140x.dat')
       PARAMETER(FNCOF5=
c     $ '../../Coef/merged_set5_m130x.dat')
c     $ '../../CutCoef/dummy_set5.dat')
c     $ '../../CutCoef/set5_m130x.dat')
     $ '../../CutCoef/set5_m140x.dat')
       PARAMETER(FNCOF6=
c     $ '../../Coef/merged_set6_m130x.dat')
c     $ '../../CutCoef/dummy_set6.dat')
c     $ '../../CutCoef/set6_m130x.dat')
     $ '../../CutCoef/set6_m140x.dat')
       PARAMETER(FNCOF7=
c     $ '../../Coef/merged_set7_m130x.dat')
c     $ '../../CutCoef/dummy_set7.dat')
c     $ '../../CutCoef/set7_m130x.dat')
     $ '../../CutCoef/set7_m140x.dat')
       PARAMETER(FNCO2 =
c     $ '../../Coef/m130x_rawcoef_co2_fowp.dat')
c     $ '../../CutCoef/co2_m130x.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNSO2 =
c     $ '../../CutCoef/so2_m130x.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNHNO3 =
c     $ '../../CutCoef/hno3_m130x.dat')
     $ '../../CutCoef/dummy_co2.dat')
       PARAMETER(FNN2O =
c     $ '../../CutCoef/n2o_m130x.dat')
     $ '../../CutCoef/dummy_n2o.dat')
       PARAMETER(FNOPTR=
c     $ '../../Coef/merged_optran_fowp_m130x.dat')
c     $ '../../Coef/merged_optran_fmw_m130x.dat')
c     $ '../../CutCoef/dummy_optran.dat')
c     $ '../../CutCoef/optran_m130x.dat')
     $ '../../CutCoef/optran_m140x.dat')
       PARAMETER(FNTHER=
     $ 'no_such_file')
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '../../Scripts/profref_trace385')
       PARAMETER(FNSUN =
c     $ '/spinach/s6/hannon/AIRS_prod08/Fit_ftc/Solar/solar_m130x.txt')
     $ '/spinach/s6/hannon/AIRS_prod08/Fit_ftc/Solar/solar_m140x.txt')
       PARAMETER(FNCOFN=
     $ '/asl/data/sarta_database/Data_jan04untun/Coef/setnte_oct05.dat')
C
C
...
C
       PARAMETER(FNTMLT=
c     $ '../../Tunmlt/tunmlt_m130x_wcononly.txt')
     $ '../../Tunmlt/tunmlt_m140x_wcononly.txt')
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C
C      ----------------
