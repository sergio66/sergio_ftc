...
subplot(211)
plot(id,bt140,'g'),grid,title('CO2')
subplot(212)
plot(id,btold-btold_co2,'k.-', id,bt130-bt130_co2,'b', ...
     id,bt140-bt140_co2,'g',   id,bt150-bt150_co2,'r', ...
     id,bt130x-bt130x_co2,'c', id,bt140x-bt140x_co2,'m' ),grid
blowup
pause
...
disp('k=old, b=130, g=140, r=150, c=130x, m=140x')
subplot(211)
plot(id,bt140,'g'),grid,title('SO2')
subplot(212)
plot(id,btold-btold_so2,'k.-', id,bt130-bt130_so2,'b', ...
     id,bt140-bt140_so2,'g',   id,bt150-bt150_so2,'r', ...
     id,bt130x-bt130x_so2,'c', id,bt140x-bt140x_so2,'m' ),grid
blowup
pause
...
disp('k=old, b=130, g=140, r=150, c=130x, m=140x')
subplot(211)
plot(id,bt140,'g'),grid,title('HNO3')
subplot(212)
plot(id,btold-btold_hno3,'k.-', id,bt130-bt130_hno3,'b', ...
     id,bt140-bt140_hno3,'g',   id,bt150-bt150_hno3,'r', ...
     id,bt130x-bt130x_hno3,'c', id,bt140x-bt140x_hno3,'m' ),grid
blowup
pause
...
disp('k=old, b=130, g=140, r=150, c=130x, m=140x')
subplot(211)
plot(id,bt140,'g'),grid,title('N2O')
subplot(212)
plot(id,btold-btold_n2o,'k.-', id,bt130-bt130_n2o,'b', ...
     id,bt140-bt140_n2o,'g',   id,bt150-bt150_n2o,'r', ...
     id,bt130x-bt130x_n2o,'c', id,bt140x-bt140x_n2o,'m' ),grid
blowup
pause
