...
C  $          RES,SECANG,  ALAT,    FX, DZREF,FIXMUL,CONPRD,
...
C    Apr 10 1995 Scott Hannon   New header comments; redefined WZ;
C                               changed SECANG to array
C    Sep  6 1995 Scott Hannon   Correct WZ for top layer
...
C      =================================================================
     ...
     $     PRES,SECANG,  ALAT,    FX, DZREF,FIXMUL,CONPRD,
