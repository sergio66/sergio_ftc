...
!DESCRIPTION:
C    March 2005 version of the 100 layer AIRS Fast Transmittance
...
C
ccc
c Uncomment one of these to apply a nonLTE fudge factor
c      DRAD=1.50*DRAD ! used with the March 2005 nonLTE
c      DRAD=1.30*DRAD
c      DRAD=1.20*DRAD
c      DRAD=1.10*DRAD
ccc
