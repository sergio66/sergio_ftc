...
C 13 Sep 2001 Scott Hannon      Assign PROF.irinst for generic AIRS
...
C         Convert from Watts/m^2/cm^-1 to milliWatts/m^2/cm^-1
       ...
       ENDDO
C
C      If not already set, set instrument type to AIRS code
       IF (PROF.irinst .LE. 0) THEN
          PROF.irinst=800  ! generic AIRS = code number 800
       ENDIF
C
C      -------------------------
