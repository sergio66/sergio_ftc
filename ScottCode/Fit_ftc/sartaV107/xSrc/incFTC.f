...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       ...
       PARAMETER( VSCOEF = 'AIRS 08-04-29 Apr08 m140' )
...
Cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
       PARAMETER(FNCOF1=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set1_m140.dat')
       PARAMETER(FNCOF2=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set2_m140.dat')
       PARAMETER(FNCOF3=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set3_m140.dat')
       PARAMETER(FNCOF4=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set4_m140.dat')
       PARAMETER(FNCOF5=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set5_m140.dat')
       PARAMETER(FNCOF6=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set6_m140.dat')
       PARAMETER(FNCOF7=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/set7_m140.dat')
       PARAMETER(FNCO2 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/CO2_m140.dat')
       PARAMETER(FNSO2 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/SO2_m140.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/HNO3_m140.dat')
       PARAMETER(FNN2O =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/N2O_m140.dat')
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/optran_m140.dat')
       PARAMETER(FNTHER=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/therm_m140.dat')
       PARAMETER(FNCOFN=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/nonLTE_m140.dat')
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Coef/profref_trace385')
       PARAMETER(FNSUN =
     $ '/asl/data/sarta_database/Data_AIRS_apr08/Solar/solar_m140.txt')
C
C
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C Tuning filename
