...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       ...
       PARAMETER( VSCOEF = '2.00 08-01-09 IASI Jan08 con1 gauss 2cm')
...
c       PARAMETER(MXCHN1 = 4338) ! old
       PARAMETER(MXCHN1 = 4435) ! new
       PARAMETER( N1CON = 7)
       PARAMETER( N1FIX = 8)
       PARAMETER( N1H2O = 11)
       PARAMETER(  N1O3 = 5)
...
c       PARAMETER(MXCHN3 = 828) ! old
       PARAMETER(MXCHN3 = 731) ! new
       PARAMETER( N3CON = 7)
       PARAMETER( N3FIX = 8)
       PARAMETER( N3CH4 = 9)
       PARAMETER( N3H2O = 11)
...
C      Used in part by modules:
       INTEGER MXCHNW ! max # of channelss with OPTRAN H2O coefs (1513)
...
c       PARAMETER(MXCHNW = 1513) ! old
       PARAMETER(MXCHNW = 2211) ! new
...
C
       PARAMETER(FNCOF1=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set1.dat')
       PARAMETER(FNCOF2=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set2.dat')
       PARAMETER(FNCOF3=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set3.dat')
       PARAMETER(FNCOF4=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set4.dat')
       PARAMETER(FNCOF5=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set5.dat')
       PARAMETER(FNCOF6=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set6.dat')
       PARAMETER(FNCOF7=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/set7.dat')
       PARAMETER(FNCO2 =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/co2.dat')
       PARAMETER(FNSO2 =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/so2.dat')
       PARAMETER(FNHNO3 =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/hno3.dat')
       PARAMETER(FNN2O =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/n2o.dat')
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/optran.dat')
       PARAMETER(FNTHER=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/therm.dat')
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/profref_trace385')
       PARAMETER(FNSUN =
     $ '/asl/data/sarta_database/Data_IASI_jan08/Solar/solardata.txt')
       PARAMETER(FNCOFN=
     $ '/asl/data/sarta_database/Data_IASI_jan08/Coef/nte.dat')
C
C
...
C
       PARAMETER(FNTMLT=
     $ '/asl/data/sarta_database/Data_IASI_sep03/CutCoef/'
     $ // 'tunmlt_ones.txt')
