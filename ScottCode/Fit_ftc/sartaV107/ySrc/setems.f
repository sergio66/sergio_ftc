...
!CALL PROTOCOL
C    RDEMIS ( NCHAN, NEMIS, NRHO, FREQ, XEMIS, FEMIS, XRHO, FRHO,
...
C    INTEGER   NRHO    number of rho pts           none
...
C    REAL arr  FRHO    raw reflec freq points      cm^-1
...
C      =================================================================
       SUBROUTINE SETEMS ( NCHAN, NEMIS, NRHO, FREQ, XEMIS, FEMIS,
