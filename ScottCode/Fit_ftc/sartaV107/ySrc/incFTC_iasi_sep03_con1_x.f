...
C      version template    '#.## YY-MM-DD <--------comment--------->'
       PARAMETER( VSARTA = '1.07 07-05-02 dummy N2O SO2 HNO3 x-tun' )
       PARAMETER( VSCOEF = '1.02 07-04-26 IASI Sep03 con1 gauss 2cm')
...
C
       PARAMETER(FNCOF1=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set1_con1.dat')
       PARAMETER(FNCOF2=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set2_con1.dat')
       PARAMETER(FNCOF3=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set3_con1.dat')
       PARAMETER(FNCOF4=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set4_con1.dat')
       PARAMETER(FNCOF5=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set5_con1.dat')
       PARAMETER(FNCOF6=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set6_con1.dat')
       PARAMETER(FNCOF7=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/set7_con1.dat')
       PARAMETER(FNCO2 =
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/co2.dat')
       PARAMETER(FNSO2 =
     ...
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/dummy_n2o.dat')
       PARAMETER(FNOPTR=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/optran.dat')
       PARAMETER(FNTHER=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/therm6.dat')
       PARAMETER(FNFX  =
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/fx.txt')
       PARAMETER(FNPREF=
     $ '/asl/data/sarta_database/Data_IASI_sep03/Coef/profref_trace')
       PARAMETER(FNSUN =
