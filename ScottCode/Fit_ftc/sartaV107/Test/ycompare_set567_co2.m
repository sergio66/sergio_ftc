...
% Read in 375.387
hfile = 'yrad567_m140_375375.rtp';
[head,hattr, prof, pattr] = rtpread(hfile);
btcm2h = radtot(f,prof.rcalc);

% Read in 385.000
hfile = 'yrad567_m140_385000.rtp';
[head,hattr, prof, pattr] = rtpread(hfile);
btc0 = radtot(f,prof.rcalc);

% Read in 394.625
hfile = 'yrad567_m140_394625.rtp';
[head,hattr, prof, pattr] = rtpread(hfile);
btcp2h = radtot(f,prof.rcalc);

% Read in 404.250
hfile = 'yrad567_m140_404250.rtp';
[head,hattr, prof, pattr] = rtpread(hfile);
btcp5 = radtot(f,prof.rcalc);

% Read in 413.875
hfile = 'yrad567_m140_413875.rtp';
[head,hattr, prof, pattr] = rtpread(hfile);
