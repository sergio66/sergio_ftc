...
subplot(212),plot(id,rms3,'b',id,rms3o,'c',id,rms1o,'r',id,rms13,'k', ...
  id(ind_best3),rms3(ind_best3),'bo',id(ind_best3o),rms3o(ind_best3o),'co',...
  id(ind_not3),rms1o(ind_not3),'ro'),grid
