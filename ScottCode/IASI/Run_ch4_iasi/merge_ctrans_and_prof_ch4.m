...
prefix=['../CH4_trans_iasi/ctrans_iasi_ch4_'];
ip=1;
...
for il=1:nlay
   temp(il,:)= reshape(ones(nang,1)*prof.ptemp(il,:),1,nprofang);
    ...
    ch4(il,:)= reshape(ones(nang,1)*prof.gas_6(il,:),1,nprofang);
end
clear prof
