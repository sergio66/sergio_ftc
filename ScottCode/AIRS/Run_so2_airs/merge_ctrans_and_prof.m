...
outnameprefix = [csname '_alldata_so2_'];
...
if (strcmp(csname(nchar),'x'))
   prefix=['../Data' tefname '/SO2trans_' band '/so2_' csname tefname ...
      '_' band '_'];
else
   prefix=['../Data' tefname '/SO2trans_' band '/so2_' csname 'f'...
      '_' band '_'];
end
ip=1;
...
tauzs=zeros(nchan,nlay,nprofang);
%
clear secang
