...
% Update: 27 Apr 2009, S.Hannon - minor update for Apr09 CrIS production
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
comment='Nov 2009 CrIS RTA production';
...
thermfile=['../Therm_crishires/therm_' csname];


%%%%%%%
% outfile: Name prefix of output matlab file to create
outfile=['thermdata_' csname];
