...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Write header record: nang, nlay, ngasm1, nchan
ifm=4*4;
...
ic=fwrite(fid,ngasm1,'integer*4');
...
ifm=ngasm1*4;
ic=fwrite(fid,ifm,'integer*4');
ic=fwrite(fid,gasid(gasindkeep),'integer*4');
ic=fwrite(fid,ifm,'integer*4');
...
for igas=1:ngasm1
   ic=fwrite(fid,ifm,'integer*4');
   ic=fwrite(fid,amount(1:nlay,gasindkeep(igas)),'real*4');
   ic=fwrite(fid,ifm,'integer*4');
end
...
for ichan=1:nchan
   ...
   ic=fwrite(fid,ctrans(irowkeep,ichan),'real*4');
   ic=fwrite(fid,ifm,'integer*4');   
end
