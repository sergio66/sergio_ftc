...
%id_long = [628:743, 795:866]; % without guard channels
%id_short= 1260:1300; % without guard channels
id_long = [634:721, 722:747, 809:878]; % with guard channels
id_short= 1282:1321; % with guard channels
iang_long = 1:6;
iang_short=1:12;

% Input data name
prefix=['../SO2_trans_cris/ctrans_so2_cris_'];
