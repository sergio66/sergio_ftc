...
angle = 12; %% this is one of the larger satzens, and will not be important in TIR !!!
angle = 8;  %% this is typically the max satzen ... and things seem ok out to this angle
jj = angle;
...
for pp = 1 : 49
  ...
  fprintf(1,'angle %2i of 14, profile %2i of 49 \n',jj,pp);
