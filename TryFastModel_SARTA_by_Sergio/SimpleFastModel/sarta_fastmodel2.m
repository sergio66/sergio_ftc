...
ret
plot(meanerr_rx(4:100),4:100,'rx-',meanerr_tryIndODrx(4:100),4:100,'co-',...
     stderr_rx(4:100),4:100,'m--',stderr_tryIndODrx(4:100),4:100,'g--'); grid     
  hl=legend('meanCORRECT','meanTRYINDOD','stdCORRECT','stdTRYINDOD','location','best');
xlabel('mean BT error between kCARTA and eff SARTA')
ylabel('layer (1=gnd,100=TOA')