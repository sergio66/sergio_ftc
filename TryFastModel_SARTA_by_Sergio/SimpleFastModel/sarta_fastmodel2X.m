...
figure(1)
plot(qcFWO(1,:),1:iNlay-2,'bo-',qcFW(1,:),1:iNlay-2,'g+-',qcF(1,:),1:iNlay-2,'rs-'); hold on
plot(qcFWO,1:iNlay-2,'bo-',qcFW,1:iNlay-2,'g+-',qcF,1:iNlay-2,'rs-'); hold off
%plot(qcFWO(2,:),1:iNlay-2,'bo-',qcFW(2,:),1:iNlay-2,'g+-',qcF(2,:),1:iNlay-2,'rs-'); grid
...
figure(2)
plot(Feff(1,:),1:iNlay-2,'bo-',Weff(1,:),1:iNlay-2,'g+-',Oeff(1,:),1:iNlay-2,'rs-'); 
hold on
plot(Feff,1:iNlay-2,'bo-',Weff,1:iNlay-2,'g+-',Oeff,1:iNlay-2,'rs-'); 
hold off
...
figure(3)
plot(FtryIndOD(1,:),1:iNlay-2,'bo-',WtryIndOD(1,:),1:iNlay-2,'g+-',OtryIndOD(1,:),1:iNlay-2,'rs-'); 
hold on
plot(FtryIndOD,1:iNlay-2,'bo-',WtryIndOD,1:iNlay-2,'g+-',OtryIndOD,1:iNlay-2,'rs-'); 
hold off
