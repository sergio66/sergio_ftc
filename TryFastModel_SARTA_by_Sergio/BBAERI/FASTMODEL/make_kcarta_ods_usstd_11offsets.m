...
for iBand = 1 : 2
  f1 = iaBand(iBand);
  f2 = iaBand(iBand+1);
  [h,ha,p,pa] = oldrtpread('regr_usstd_11offsets.op.rtp');
  ...
  for ip = 1 : length(p.stemp)
    for ix = 1 : 4
      fprintf(1,'Band = %4i TempOffset = %2i  iWV/CO2/O3/XYZ = %3i \n\n',f1,ip,ix);
      ...
      if ix == 1
        ...
        outfile = ['/asl/s1/sergio/BBAERI/WV/prof_11us_std_' num2str(ip) '_B_' num2str(f1) '.dat'];
      ...
      elseif ix == 2
        ...
        outfile = ['/asl/s1/sergio/BBAERI/CO2/prof_11us_std_' num2str(ip) '_B_' num2str(f1) '.dat'];
        kcartaer = ['!' kcartaexec ' ' outnml ' ' outfile];
      ...
      elseif ix == 3
        ...
        outfile = ['/asl/s1/sergio/BBAERI/O3/prof_11us_std_' num2str(ip) '_B_' num2str(f1) '.dat'];
        kcartaer = ['!' kcartaexec ' ' outnml ' ' outfile];
      ...
      elseif ix == 4
        ...
        outfile = ['/asl/s1/sergio/BBAERI/OTHERS/prof_11us_std_' num2str(ip) '_B_' num2str(f1) '.dat'];
        kcartaer = ['!' kcartaexec ' ' outnml ' ' outfile];
