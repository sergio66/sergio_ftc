...
% clustcmd -L find_predictors_uplook49_605v2.m 1:2390
%
% otherwise when happy
% clustcmd -q short -n 72 find_predictors_uplook49_605v2.m 1:2390

disp('hello sergio this is "find_predictors_uplook49_605v2.m" ')
JOB
iChan0 = JOB(1);
...
saver = ['save COEFFS/605/water605_chan' num2str(iChan0) '.mat iChan origCW *CW *coeffW *listW'];
eval(saver)
...
saver = ['save COEFFS/605/fixed605_chan' num2str(iChan0) '.mat iChan origCF *CF *coeffF *listF'];
eval(saver)
...
saver = ['save COEFFS/605/ozone605_chan' num2str(iChan0) '.mat iChan origCOz *COz *coeffOz *listOz'];
eval(saver)
...
%% quickcheck_odpredictors_radtrans605v2
